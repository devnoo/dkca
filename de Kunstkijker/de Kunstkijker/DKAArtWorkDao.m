...
-(NSMutableArray *) getMyArtworks{
    ...
    @try {
        ...
        const char *sql = "SELECT objectnummer, titel, vervaardiger, thumb, beschrijving, objectnaam, techniek, startdatum, einddatum, hoogte, breedte, diepte, parent  FROM artworks";
        ...
        while (sqlite3_step(sqlStatement) == SQLITE_ROW){
            ...
            if (sqlite3_column_text(sqlStatement,4)){
                artwork.description = [NSString stringWithUTF8String:(char *) sqlite3_column_text(sqlStatement,4)];    
            }
